...
for (algo in algorithms) {
  ...
  cat("  Adjusted R² (best):", round(result$best_r2, 4), "\n")
  cat("  All Adjusted R² values:\n")
  for (model_name in names(result$adj_r2_all)) {
    cat("    ", model_name, ":", round(result$adj_r2_all[[model_name]], 4), "\n")
  }
